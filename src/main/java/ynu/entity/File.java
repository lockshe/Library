...
public class File {
	...
	private String localUrl;//本地服务器存储路径

	private String visitUrl;//客户端访问路径
	...
	public File(String name, String suffix, String localUrl, String visitUrl, String description, String tag,
	...
	public File(long id, String name, String suffix, String localUrl, String visitUrl, long size, Timestamp createTime,
			String description, int checkTimes, int downloadTimes, String tag, int userId, int categoryId,
			int isDownloadable, int isUploadable, int isVisible, int isDeletable, int isUpdatable,
